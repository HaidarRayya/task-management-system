...
class AttachmentService
{
    ...
    {
        try {
            $attachment = Attachment::findOrFail($attachment_id)->load('user.role');
     ...
     * @return AttachmentResource attachment  
     */
    public function createAttachment($attachmentData, $task)
    {
     ...
     * @return AttachmentResource attachment  
     */
    public function updateAttachment($attachmentData, $attachment_id)
    {
        $attachmentInfo = AssetsService::storeFile($attachmentData);
        try {
